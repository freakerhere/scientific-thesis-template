...
\theorempreskipamount 1ex plus 1ex minus 0.5ex
\theorempostskipamount 1ex plus 1ex minus 0.5ex
% \theoremstyle{break}
%
% EN: Add line break in theorem header according to
% https://tex.stackexchange.com/questions/266627/linebreak-in-definition-heading-theorem-package?newreg=9a46ba4591404b4485335fe7c990b65d
\makeatletter
...
%
\definecolor{text_highlight_border}{rgb}{0.35,0.35,0.35}
\definecolor{text_highlight}{rgb}{0.95,0.95,1}
\newenvironment{Contribution}[1][\unskip]{%
  \def\FrameCommand{%
    {\color{text_highlight_border}\vrule width 1pt}%
    % {\color{text_highlight}\vrule width 4pt}%
    \colorbox{text_highlight}%
  }%
  \MakeFramed{\advance\hsize-\width\FrameRestore}%
  \begin{adjustwidth}{4pt}{5pt}%
		\vspace{-5pt}
	\begin{contribution}[#1]
}
{
	\end{contribution}
	\vspace{0pt}
...
%
\usepackage[
  left=1.8cm,right=1.8cm,top=1.5cm,bottom=1cm,
  headsep=18pt,
  footskip=30pt,
  includehead,
  includefoot
...
\makeatletter
  ...
  \renewcommand{\DOCH}{%
    ...
    % set position of chapter box to fit a5paper and margins set with geometry
    \makebox[12.16cm][r]{
      \rotatebox{90}{
        \makebox[2cm]{
