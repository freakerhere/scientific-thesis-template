...
\documentclass[
  ...
  a5paper,  % Standard format - only KOMAScript uses paper=a4 - https://tex.stackexchange.com/a/61044/9075
...
% \Titelblatt
THIS PAGE HAS TO BE REPLACED BY THE ACTUAL TITLEPAGE.
\cleardoublepage
...
\begin{Contribution}[A Method for Applying Patterns based on Concrete Solutions]
    \blindtext
\end{Contribution}
